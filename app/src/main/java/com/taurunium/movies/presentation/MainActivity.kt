...
import com.taurunium.movies.databinding.ActivityMainBinding
import com.taurunium.movies.databinding.ListItemBinding
import com.taurunium.movies.di.Injector
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (application as Injector).createMovieSubComponent().inject(this) //injecting movie activity
